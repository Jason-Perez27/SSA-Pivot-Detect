...
class LandsatDataExporter:
    def __init__(self, shapefile_path, drive_folder, service_account, service_account_key_path, OAuth_path, max_tasks=50):
        ...
        #Checks token.pickle for authorization (automatically linked to project)
...
if __name__ == '__main__':
    ...
    OAuth_path = 'c:/Users/jdper/Desktop/client_secret_722535392652-5cqbasibb66lkhergm2k6f8ql7bnc60r.apps.googleusercontent.com.json'
    exporter = LandsatDataExporter(shapefile_path, drive_folder, service_account, service_account_key_path, OAuth_path)
